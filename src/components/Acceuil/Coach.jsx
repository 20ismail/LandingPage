        ...
        <section id="about" className="section">
          <div className="container about-container">
            ...
            <div className="about-text">
              ...
              <p>أنا العربي، خبير في التطوير الذاتي والقيادة مع أكثر من 15 سنة من الخبرة. ساعدت أكثر من 500 عميل على تحقيق أهدافهم وتحسين جودة حياتهم.</p>
              <p>أؤمن بأن كل شخص لديه إمكانات هائلة تحتاج فقط إلى التوجيه الصحيح لتظهر. مهمتي هي مساعدتك على اكتشاف هذه الإمكانات وتطويرها.</p>
              <ul>
                <li>ماجستير في علم النفس التطويري من جامعة القاهرة</li>
                <li>عضو في الاتحاد الدولي للمدربين المحترفين</li>
                <li>متحدث رئيسي في مؤتمرات التنمية البشرية</li>
                <li>مؤلف كتاب "قوة التحول الشخصي"</li>
              </ul>
            </div>
          </div>
        </section>
